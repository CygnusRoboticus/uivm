import { AnyConfig, ArrayConfig, FieldConfig, FormConfig, FormItemConfig, GroupConfig } from "./configs";
...
type FieldTypeType<
  ...
  TFormItem extends FormItemConfig = FormItemConfig,
  TS = unknown,
  TN = unknown,
  TB = unknown,
  TArray = unknown,
...
type MappedFields<
  T extends readonly FormItemConfig[],
  TMap extends FieldTypeMap<TFormItem, TS, TN, TB, TArray, TNull>,
  TFormItem extends FormItemConfig = FormItemConfig,
  TS = unknown,
  TN = unknown,
